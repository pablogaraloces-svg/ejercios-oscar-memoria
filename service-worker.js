 ...
 */
const CACHE_VERSION = "acompanante-v2.6";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./manifest.json",
  ...
  "./js/core/weather.js",
  "./js/core/version.js",
  "./js/core/gameSounds.js",
  "./js/core/gameStats.js",
  "./js/core/dateUtils.js",
  "./js/core/profiles.js",
  "./js/core/dragReorder.js",
  "./js/core/mascot.js",
  ...
  "./js/screens/gamePlayer.js",
  "./js/screens/gameRoom.js",
  "./js/screens/simonGame.js",
  "./js/screens/wordSearchGame.js",
